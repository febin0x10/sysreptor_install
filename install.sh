...
echo "Installing Docker Compose V2 temporarily.."
echo ""
mkdir /tmp/tmpdir
curl -SL https://github.com/docker/compose-cli/releases/download/v2.0.0-rc.1/docker-compose-linux-amd64 -o /tmp/tmpdir/docker-compose
export PATH=/tmp/tmpdir:$PATH
